...
derivata_alfa_R1 = (2 * R2_valore * (1 - (2 * R1_valore + R2_valore) / np.sqrt(R1_valore*2 + 4 * R1_valore * R2_valore))) / (2 * R2_valore + R1_valore + np.sqrt(R1_valore2 + 4 * R1_valore * R2_valore))*2
derivata_alfa_R2 = 2 / (2 * R2_valore + R1_valore + np.sqrt(R1_valore*2 + 4 * R1_valore * R2_valore)) - (4 * R2_valore) / (np.sqrt(R1_valore2 + 4 * R1_valore * R2_valore) * (2 * R2_valore + R1_valore + np.sqrt(R1_valore2 + 4 * R1_valore * R2_valore))*2)
